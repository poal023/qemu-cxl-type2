...
/* CXL r3.2 Section 8.1.3.2: DVSEC CXL Capability */
#define CXL_DVSEC_CACHE_CAPABLE   0x0001
#define CXL_DVSEC_IO_CAPABLE      0x0002
#define CXL_DVSEC_MEM_CAPABLE     0x0004
#define CXL_DVSEC_HDM_COUNT_MASK  0x0030
#define CXL_DVSEC_WBINVD_CAPABLE  0x0040

/* CXL r3.2 Section 8.1.3.3: DVSEC CXL Control */
#define CXL_DVSEC_CACHE_ENABLE    0x0001
#define CXL_DVSEC_IO_ENABLE       0x0002
#define CXL_DVSEC_MEM_ENABLE      0x0004

/* CXL r3.2 Section 8.1.3.5: DVSEC CXL Control2 */
#define CXL_DVSEC_DISABLE_CACHING 0x0001
#define CXL_DVSEC_INIT_WBINVD     0x0002

/* CXL r3.2 Section 8.1.3.6: DVSEC CXL Status2 */
#define CXL_DVSEC_CACHE_INVALID   0x0001

/* CXL r3.2 Section 8.1.3.7: DVSEC CXL Capability2 */
#define CXL_DVSEC_CACHE_UNIT_MASK  0x000f
#define CXL_DVSEC_CACHE_UNIT_SHIFT 0
#define CXL_DVSEC_CACHE_SIZE_MASK  0xff00
#define CXL_DVSEC_CACHE_SIZE_SHIFT 8
#define CXL_DVSEC_CACHE_UNIT_64K   1
#define CXL_DVSEC_CACHE_UNIT_1M    2
